...
PUT THESE FIELDS FIRST — they are most important:
{
  ...
  "rental": {
    "marketRent": {
      "estimated": <number — best estimate of monthly gross rent for this property, based on comps, bed/bath/sqft, and market data>,
      "lowEnd": <number — conservative 10th percentile>,
      "highEnd": <number — optimistic 90th percentile>,
      "rentPerSqft": <number — monthly rent / sqft>,
      "hudFMR": <number or null — HUD Fair Market Rent for this bedroom count in this county, if known>,
      "source": "<Zillow / Rentometer / HUD FMR / Market estimate>",
      "confidence": "<HIGH|MEDIUM|LOW>",
      "comps": [{"address":"<addr or generic>","beds":<n>,"rent":<n>,"source":"<>"}]
    },
    "income": {
      "monthlyGrossRent": <number — use marketRent.estimated>,
