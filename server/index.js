...
app.post('/api/override/:uid', auth, (req, res) => {
  try {
    ...
    if (field === 'urbanARV') { uw.arv.urbanARV = parseFloat(value); uw.arv.overridden = true; }
      ...
      uw.rehab.overriddenAt = new Date().toISOString();
      // Accept individual line items if sent (from editable rehab calc)
      if (req.body.lineItems && typeof req.body.lineItems === 'object') {
        uw.rehab.lineItems = { ...uw.rehab.lineItems, ...req.body.lineItems };
      }
    }
